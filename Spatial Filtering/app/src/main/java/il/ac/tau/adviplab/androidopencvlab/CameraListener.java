    ...
    public Mat onCameraFrame(CameraBridgeViewBase.CvCameraViewFrame inputFrame) {
        ...
        switch (mViewMode) {
            ...
            case VIEW_MODE_SOBEL:
                MyImageProc.sobelCalcDisplay(mImToProcess, inputFrame.gray(), mFilteredImage);
                break;
            case VIEW_MODE_GAUSSIAN:
                MyImageProc.gaussianCalcDisplay(mImToProcess, inputFrame.gray(), mFilteredImage);
                break;
            case VIEW_MODE_BILATERAL:
                MyImageProc.bilateralCalcDisplay(mImToProcess, inputFrame.gray(), mFilteredImage);
                break;
