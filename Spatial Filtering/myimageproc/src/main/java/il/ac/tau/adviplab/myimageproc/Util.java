...
public class Util {
    private static final String TAG = "myimageproc.Util";

    public static <image> Bitmap getBitmap(Context context, Uri uri) {
        InputStream in;
        try {
            ...
            int n = (int) Math.floor(0.5 * Math.log((float) options.outWidth
